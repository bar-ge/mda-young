    ...
    <div className="flex flex-col gap-4 pt-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col gap-1">
          ...
          <span className="text-xs text-gray-500 font-medium">Confirmed Shifts</span>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col gap-1">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center gap-3 py-16 text-center">
          ...
          <p className="text-gray-400 text-sm">
            {tab === 'upcoming' ? 'No upcoming shifts.\nGo apply for some!' : 'No past shifts yet.'}
          </p>
        </div>
      ) : (
              ...
              <div key={a.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col gap-3">
                ...
                {!isPast && a.status === 'confirmed' && (
                  <div className="flex items-center gap-2 bg-emerald-50 rounded-xl p-3">
                    ...
                    <span className="text-xs text-emerald-700 font-medium">You&apos;re confirmed for this shift</span>
                  </div>
                )}
              </div>
            )
