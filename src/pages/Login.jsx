              ...
              {mode === 'login' && (
                <form key="login" onSubmit={handleLogin} className="animate-slide-in-right flex flex-col gap-4">
                  ...
                  <button type="button" onClick={() => handleOAuth('google')}
                    className="w-full flex items-center justify-center gap-2 py-3 border border-gray-200 rounded-2xl text-sm font-semibold text-gray-700 hover:bg-gray-50 active:scale-[0.98] transition-all duration-200">
