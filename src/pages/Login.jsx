              ...
              {mode === 'login' && (
                <form key="login" onSubmit={handleLogin} className="animate-slide-in-right flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] text-gray-400 font-medium shrink-0">או המשך עם</span>
                    <div className="flex-1 h-px bg-gray-100" />
                  </div>

                  <button type="button" onClick={() => handleOAuth('google')}
                    disabled={loading} className="w-full flex items-center justify-center gap-2 py-3 border border-gray-200 rounded-2xl text-sm font-semibold text-gray-700 hover:bg-gray-50 active:scale-[0.98] transition-all duration-200 disabled:opacity-50">
                ...
                <div key={`step-${step}`}
                  ...
                  {step === 1 && (
                    <>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex-1 h-px bg-gray-100" />
                        <span className="text-[10px] text-gray-400 font-medium shrink-0">או הירשם עם</span>
                        <div className="flex-1 h-px bg-gray-100" />
                      </div>
